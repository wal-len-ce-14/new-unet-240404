...
UPP_trainl, UPP_loss, UPP_acc, UPP_dice, UPP_iou = train(modelUPP, 16, 1e-3, "./img/images/", "./img/masks", epochs=30, name=f"Unet++_{testID}")
UP_trainl, UP_loss, UP_acc, UP_dice, UP_iou = train(modelUP, 16, 1e-3, "./img/images/", "./img/masks", epochs=30, name=f"Unet+_{testID}")
U_trainl, U_loss, U_acc, U_dice, U_iou = train(modelU, 16, 1e-3, "./img/images/", "./img/masks", epochs=30, name=f"Unet_{testID}")
M_trainl, M_loss, M_acc, M_dice, M_iou = train(modelMy, 16, 1e-3, "./img/images/", "./img/masks", epochs=30, name=f"MyUnet_{testID}")
...
plt.legend()
plt.xticks(range(0, len(UPP_trainl), 5))
plt.title("Unet vs Unet+ vs Unet++ vs M --loss")
...
plt.legend()
plt.xticks(range(0, len(UPP_trainl), 5))
plt.title("Unet vs Unet+ vs Unet++ vs M --acc")
...
plt.legend()
plt.xticks(range(0, len(UPP_trainl), 5))
plt.title("Unet vs Unet+ vs Unet++ vs M --dice")
...
plt.legend()
plt.xticks(range(0, len(UPP_trainl), 5))
plt.title("Unet vs Unet+ vs Unet++ vs M --iou")
...
plt.title("Unet vs M --iou")
plt.savefig(f"plt/Unet-vs-M-iou_{testID}.png")
plt.close()
# plt.show()
...
plt.legend()
plt.xticks(range(0, len(U_iou), 5))
plt.title("Unet vs M --dice")
plt.savefig(f"plt/Unet-vs-M-dice_{testID}.png")
plt.close()
# plt.show()